    ...
    1319: function(e, t, n) {
        ...
        var z, j, D, O = null, P = {
            ...
            mounted: function() {
                ...
                this.instanceSound = new _.Howl({
                    src: ["../infinitecraft/instance.mp3"],
                    volume: .5
                }),
                this.rewardSound = new _.Howl({
                    src: ["../infinitecraft/reward.mp3"],
                    volume: .4
                }),
                this.deleteSound = new _.Howl({
                    src: ["../infinitecraft/delete.mp3"],
                    volume: .45
                }),
                this.errorSound = new _.Howl({
                    src: ["../infinitecraft/error.mp3"],
                    volume: .4
                }),
                this.discoverySound = new _.Howl({
                    src: ["../infinitecraft/discovery.mp3"],
                    volume: .1,
                    rate: 1.1
                }),
                    ...
                    return regeneratorRuntime.wrap((function(e) {
                        for (; ; )
                            ...
                            case 0:
                                ...
                                c = "https://cors-anywhere.herokuapp.com/https://infiniteback.org/pair?first=".concat(encodeURIComponent(o[0].text), "&second=").concat(encodeURIComponent(o[1].text)),
                                e.next = 7,
                                fetch(c, {
                                    signal: r.signal
                                });
        ...
        n(28)), component = Object(L.a)($, (function() {
            ...
            return t("div", {
                ...
                attrs: {
                    src: "../infinitecraft/dark-mode".concat(e.isDarkMode ? "-on" : "", ".svg")
                },
                on: {
                ...
                staticClass: "sound",
                attrs: {
                    src: e.isMuted ? "../infinitecraft/mute.svg" : "../infinitecraft/sound.svg"
                },
                on: {
                    click: e.toggleSound
                }
                ...
                attrs: {
                    src: "../infinitecraft/left-arrow.svg"
                }
                ...
                staticClass: "sidebar-sorting-icon",
                attrs: {
                    src: "../infinitecraft/".concat(e.sortBy, ".svg")
                }
                ...
                attrs: {
                    src: "../infinitecraft/pinwheel.png"
                }
            }) : e._e()]), e._v(" "), t("div", {
